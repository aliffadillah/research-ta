-- Seed Menu Recommendations from MBG_Historis_Latest.json
-- Category rotation: breakfast, lunch, dinner, snack
...
SELECT COUNT(*) AS menu_recommendations_inserted FROM menu_recommendations;