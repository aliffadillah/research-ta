      ...
      {(state === "success" || saved) && (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="space-y-4">
            ...
            {selectedPrediction && (
              <div className="card-static">
                <h3 className="font-semibold mb-4">Ukuran Porsi</h3>
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <div className="w-24">
                    ...
                    />
                    <p className="text-xs text-text-muted text-center mt-1">gram</p>
                  </div>
                </div>
                ...
                {selectedPrediction.nutrition && (
                  <div className="p-4 bg-primary/5 rounded-xl mb-4">
                    <p className="text-sm text-text-muted mb-2">Nutrisi untuk {portionSize}g:</p>
                    <div className="grid grid-cols-5 gap-2 text-center">
                      <div>
                        <p className="nutrition-value text-primary">
                          {Math.round(selectedPrediction.nutrition.calories * portionSize / 100)}
                        </p>
                        <p className="text-xs text-text-muted">Kalori</p>
                      </div>
                      <div>
                        <p className="nutrition-value">
                          {(selectedPrediction.nutrition.protein * portionSize / 100).toFixed(1)}g
                        </p>
                        <p className="text-xs text-text-muted">Protein</p>
                      </div>
                      <div>
                        <p className="nutrition-value">
                          {(selectedPrediction.nutrition.carbs * portionSize / 100).toFixed(1)}g
                        </p>
                        <p className="text-xs text-text-muted">Karbo</p>
                      </div>
                      <div>
                        <p className="nutrition-value">
                          {(selectedPrediction.nutrition.fat * portionSize / 100).toFixed(1)}g
                        </p>
                        <p className="text-xs text-text-muted">Lemak</p>
                      </div>
                      <div>
                        <p className="nutrition-value">
                          {(selectedPrediction.nutrition.fiber * portionSize / 100).toFixed(1)}g
                        </p>
                ...
                {saved && (
                  <div className="text-center p-4 bg-green-50 border border-green-200 rounded-xl">
                    <p className="text-green-700 font-medium">Tersimpan!</p>
                    <button onClick={reset} className="text-primary text-sm hover:underline mt-2">
                      Deteksi makanan lain
                    </button>
                  </div>
                )}
              </div>
